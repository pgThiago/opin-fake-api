            ...
            coverages: [
              {
                ...
                biometricTable:
                  '1  - Mortalidade Geral / Beneficiário - AT49 M',
...
exports.getPensionClaim = (req, res, next) => {
  ...
  const filteredData = pensionClaim.filter(
    (item) => item.pensionIdentification === pensionIdentification,
  )
...
exports.getPensionContractsInfo = (req, res, next) => {
  ...
  const filteredData = pensionContractsInfo.find(
    (item) => item.pensionIdentification === pensionIdentification,
  )
...
exports.getPensionMovements = (req, res, next) => {
  ...
  const filteredData = pensionMovements.find(
    (item) => item.pensionIdentification === pensionIdentification,
  )
...
exports.getPensionPortabilities = (req, res, next) => {
  ...
  const filteredData = pensionPortabilities.find(
    (item) => item.pensionIdentification === pensionIdentification,
  )
...
exports.getPensionWithdrawals = (req, res, next) => {
  ...
  const filteredData = pensionWithdrawals.filter(
    (item) => item.pensionIdentification === pensionIdentification,
  )
