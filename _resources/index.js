...
const {
  getPensionContracts,
  getPensionContractsInfo,
  getPensionMovements,
  getPensionPortabilities,
  getPensionWithdrawals,
  getPensionClaim,
} = require('./pension')
...
app.get('/person/:policyId/movements', (req, res) =>
  getPersonMovements(req, res),
)
app.get('/person/:policyId/policy-info', (req, res) =>
  getPersonPolicyInfo(req, res),
)
...
app.get('/pension/:pensionIdentification/contract-info', (req, res) =>
  getPensionContractsInfo(req, res),
)
app.get('/pension/:pensionIdentification/movements', (req, res) =>
  getPensionMovements(req, res),
)
app.get('/pension/:pensionIdentification/portabilities', (req, res) =>
  getPensionPortabilities(req, res),
)
app.get('/pension/:pensionIdentification/withdrawals', (req, res) =>
  getPensionWithdrawals(req, res),
)
app.get('/pension/:pensionIdentification/claim', (req, res) =>
  getPensionClaim(req, res),
)
