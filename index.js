...
const { getHousing, getHousingClaim, getHousingPolicyInfo, getHousingPremium } = require('./housing')
...
app.get('/patrimonial/:policyId/premium', (req, res) => getPatrimonialPremium(req, res))
app.get('/patrimonial/:policyId/policy-info', (req, res) => getPatrimonialPolicyInfo(req, res))
...
app.get('/aviation/:policyId/policy-info', (req, res) => getAviationPolicyInfo(req, res))
...
app.get('/financial-risk/:policyId/premium', (req, res) => getfinancialRiskPremium(req, res))
app.get('/financial-risk/:policyId/policy-info', (req, res) => getfinancialRiskPolicyInfo(req, res))
app.get('/financial-risk/:policyId/claim', (req, res) => getfinancialRiskClaim(req, res))

app.get('/nautical/:cpf', (req, res) => getNautical(req, res))
app.get('/nautical/:policyId/premium', (req, res) => getNauticalPremium(req, res))
app.get('/nautical/:policyId/policy-info', (req, res) => getNauticalPolicyInfo(req, res))
...
app.get('/petroleum/:policyId/policy-info', (req, res) => getPetroleumPolicyInfo(req, res))
...
app.get('/responsibility/:policyId/premium', (req, res) => getResponsibilityPremium(req, res))
app.get('/responsibility/:policyId/policy-info', (req, res) => getResponsibilityPolicyInfo(req, res))
app.get('/responsibility/:policyId/claim', (req, res) => getResponsibilityClaim(req, res))
...
app.get('/business/identifications/:cnpj', (req, res) => getBusinessIdentification(req, res))
app.get('/business/qualifications/:cnpj', (req, res) => getBusinessQualification(req, res))
app.get('/business/complimentary-information/:cnpj', (req, res) => getBusinessComplimentaryInfo(req, res))

app.get('/personal/identifications/:cpf', (req, res) => getPersonalIdentification(req, res))
app.get('/personal/qualifications/:cpf', (req, res) => getPersonalQualification(req, res))
app.get('/personal/complimentary-information/:cpf', (req, res) => getPersonalComplimentaryInfo(req, res))

app.get('/resources/:cpf', (req, res) => getResources(req, res))

app.get('/transport/:cpf', (req, res) => getTransport(req, res))
app.get('/transport/:policyId/premium', (req, res) => getTransportPremium(req, res))
app.get('/transport/:policyId/policy-info', (req, res) => getTransportPolicyInfo(req, res))
app.get('/transport/:policyId/claim', (req, res) => getTransportClaim(req, res))

app.get('/housing/:cpf', (req, res) => getHousing(req, res))
app.get('/housing/:policyId/premium', (req, res) => getHousingPremium(req, res))
app.get('/housing/:policyId/policy-info', (req, res) => getHousingPolicyInfo(req, res))
app.get('/housing/:policyId/claim', (req, res) => getHousingClaim(req, res))

app.get('/person/:cpf', (req, res) => getPerson(req, res))
