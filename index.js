...
app.get("/patrimonial/:cpf/premium", (req, res) =>
  getPatrimonialPremium(req, res)
);
app.get("/patrimonial/:cpf/policy-info", (req, res) =>
...
app.get("/aviation/:cpf/policy-info", (req, res) =>
...
app.get("/financial-risk/:cpf/premium", (req, res) =>
  getfinancialRiskPremium(req, res)
);
app.get("/financial-risk/:cpf/policy-info", (req, res) =>
  getfinancialRiskPolicyInfo(req, res)
);
app.get("/financial-risk/:cpf/claim", (req, res) =>
...
app.get("/nautical/:cpf/policy-info", (req, res) =>
...
app.get("/petroleum/:cpf/policy-info", (req, res) =>
...
app.get("/responsibility/:cpf/premium", (req, res) =>
  getResponsibilityPremium(req, res)
);
app.get("/responsibility/:cpf/policy-info", (req, res) =>
  getResponsibilityPolicyInfo(req, res)
);
app.get("/responsibility/:cpf/claim", (req, res) =>
